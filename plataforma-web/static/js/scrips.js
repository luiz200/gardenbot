...
// function compareValues(latest, previous) {
//     compareAndDisplay("temperature", latest.temperature, previous.temperature, "#temperature_comparison");
//     compareAndDisplay("umidade_ar", latest.umidade_ar, previous.umidade_ar, "#umidade_ar_comparison");
//     compareAndDisplay("umidade_solo1", latest.umidade_solo1, previous.umidade_solo1, "#umidade_solo1_comparison");
//     compareAndDisplay("umidade_solo2", latest.umidade_solo2, previous.umidade_solo2, "#umidade_solo2_comparison");
//     compareAndDisplay("umidade_solo3", latest.umidade_solo3, previous.umidade_solo3, "#umidade_solo3_comparison");
//     compareAndDisplay("umidade_solo4", latest.umidade_solo4, previous.umidade_solo4, "#umidade_solo4_comparison");
// }

// function compareAndDisplay(valueType, latestValue, previousValue, comparisonElementId) {
//     if (latestValue > previousValue) {
//         $(comparisonElementId).html(
//             '<div style="color: rgb(43, 255, 0);">'+
//             '<span>' + valueType + ': ' + latestValue + '</span>'+
